...
async def seed_default_data(database=None):
    ...
    default_plans = [
        ...
        {"name": "Cabin - 4 Seater", "category": "cabin", "capacity": 4, "default_rate": 0, "meeting_room_credits": 0},
        {"name": "Cabin - 6 Seater", "category": "cabin", "capacity": 6, "default_rate": 0, "meeting_room_credits": 0},
        {"name": "Open Desk", "category": "open_desk", "capacity": 1, "default_rate": 0, "meeting_room_credits": 0},
        {"name": "Hot Desk", "category": "hot_desk", "capacity": 1, "default_rate": 0, "meeting_room_credits": 0},
        {"name": "Day Pass", "category": "day_pass", "capacity": 1, "default_rate": 0, "meeting_room_credits": 0},
    ]
