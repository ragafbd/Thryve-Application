          ...
          <Card className="border border-[#2E375B]/10">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="text-sm font-semibold text-[#2E375B]">
                Rs. {selectedRoom.hourly_rate} OR {selectedRoom.credit_cost_per_slot} credits for {selectedRoom.slot_duration} minutes or part of
              </div>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="bg-[#FFA14A]/10 p-3 rounded-lg text-sm">
              ...
              <p className="text-[#FFA14A]/70 text-xs mt-1">
                If credits are insufficient, the remaining time will be billed at Rs. {selectedRoom?.hourly_rate} for {selectedRoom?.slot_duration} minutes or part of
              </p>
            </div>
